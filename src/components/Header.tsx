...
const Header = () => {
  ...
  const mentalHealthLinks = [
    ...
    { to: "/mental-health-news", label: "India Updates", icon: Newspaper, color: "text-blue-500" },
    { to: "/research-updates", label: "Research & Technology", icon: Megaphone, color: "text-indigo-500" }
  ];
  ...
  const mindMattersLinks = [
    ...
    { to: "/mind-plan", label: "My Mind Plan", icon: "📋", color: "text-teal-500" }
  ];

  const aboutLinks = [
    { to: "/pitch-deck", label: "Pitch Deck", icon: Sparkles, color: "text-cyan-500" }
  ];

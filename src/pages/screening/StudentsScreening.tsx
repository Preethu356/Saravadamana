...
import { GraduationCap, ArrowRight, CheckCircle, Brain } from "lucide-react";
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-background pb-24">
        <BackButton fallbackPath="/screening-tools?category=students" />
          ...
          >
            ...
            <Card className="p-4 bg-card/50 backdrop-blur-sm">
              ...
              <div className="space-y-2 text-sm">
                {riskScore >= 70 && (
                  <p className="text-destructive">• High academic stress detected. Professional support recommended.</p>
                )}
                {riskScore >= 50 && riskScore < 70 && (
                  <p className="text-amber-600">• Moderate stress levels. Consider stress management techniques.</p>
                )}
                {riskScore >= 30 && riskScore < 50 && (
                  <p className="text-blue-600">• Mild stress present. Maintain healthy coping strategies.</p>
                )}
                {riskScore < 30 && (
                  <p className="text-green-600">• Healthy stress levels. Continue current practices.</p>
                )}
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Button
                variant="outline"
                className="w-full"
                onClick={() => navigate("/screening-tools?category=students")}
              >
                More Screenings
              </Button>
            </div>

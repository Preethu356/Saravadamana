...
import { Heart, ArrowRight, CheckCircle, Brain } from "lucide-react";
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-background pb-24">
        <BackButton fallbackPath="/screening-tools?category=women" />
          ...
          >
            ...
            <Card className="p-4 bg-card/50 backdrop-blur-sm">
              ...
              <div className="space-y-2 text-sm">
                {riskScore >= 70 && (
                  <p className="text-destructive">• Significant wellness concerns detected. Professional support recommended.</p>
                )}
                {riskScore >= 50 && riskScore < 70 && (
                  <p className="text-amber-600">• Moderate concerns. Enhanced self-care practices recommended.</p>
                )}
                {riskScore >= 30 && riskScore < 50 && (
                  <p className="text-blue-600">• Good wellness with minor areas for improvement.</p>
                )}
                {riskScore < 30 && (
                  <p className="text-green-600">• Excellent wellness! Continue nurturing your well-being.</p>
                )}
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Button variant="outline" onClick={() => navigate("/screening-tools?category=women")}>
                More Screenings
              </Button>
            </div>
